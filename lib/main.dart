...
class HomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    double listContainerHeight = MediaQuery.of(context).size.height - 0;
...
class _ExplicitAnimationsState extends State<ExplicitAnimations>
  ...
  void initState() {
    ...
    _rotationAnimation = Tween<double>(begin: 0, end: 100).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Curves.easeInOutCubic,
      ),
